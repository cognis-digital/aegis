...
```mermaid
flowchart LR
  IN[addresses + transactions] --> P[aegis<br/>cluster + trace]
...
- **MCP server** — `aegis mcp` (Claude Desktop, Cursor, Cognis.Studio, [uncensored-fleet](https://github.com/cognis-digital/uncensored-fleet))
