"""Native cognis-connect emit for aegis — forward findings to any platform.

Maps aegis's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    aegis ... --format json | aegis-emit --to stix
    aegis-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
